...
python train_v2_main.py \
    ...
    --output_dir ./output/safety-lora_wo_g_r16_a32-ep1-svd_rank16-salora_8_16-lr_5e-5 \
    --gpu_id 3 \
    \
    --lora_rank 16 \
    --lora_alpha 32 \
    ...
    --experiment_name "safety-lora_wo_g_r16_a32-ep1-svd_rank16-salora_8_16-lr_5e-5" \
    --print_interval 10
