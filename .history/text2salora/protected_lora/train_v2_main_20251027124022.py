...
def train(
    ...
    print(f"  正交约束: {'✅ 开启' if use_orthogonal else '❌ 关闭'}")
...
def main():
    ...
    trainer = train(
        ...
        subspace_dir=args.subspace_dir if args.use_orthogonal else None,
        preference_dimensions=args.preference_dimensions if args.use_orthogonal else None,
