...
python train_v2_main.py \
    ...
    --output_dir ./output/safety-lora_wo_gateproj-ep1-svd_rank16_ortho_hard_fused \
    --gpu_id 3 \
    \
    --lora_rank 16 \
    --lora_alpha 16 \
    ...
    --experiment_name "safety-lora_wo_gateproj-ep1-svd_rank16_ortho_hard_fused" \
    --print_interval 10
