...
DATA_DIR="data"
OUTPUT_DIR="trained_probes/multi_position-llama2-1118"
...
for i in "${!dimensions[@]}"; do
    ...
    python train_multi_position_probes.py \
        --model_name $MODEL_NAME \
        --device $DEVICE \
        --good_pairs ${DATA_DIR}/helpsteer_merged_paired/${dim}_good_pairs.json \
        --bad_pairs ${DATA_DIR}/helpsteer_merged_paired/${dim}_bad_pairs.json \
        --max_samples 1000 \
        --positions $POSITIONS \
        --test_split 0.2 \
        --cv_folds 5 \
