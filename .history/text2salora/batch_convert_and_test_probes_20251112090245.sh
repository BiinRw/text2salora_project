...
# 配置
LORA_PATH = "./protected_lora/output"
LORA_DIR="$(LORA_PATH)/safety-lora_wo_g_r16_a32-ep1-svd_rank16-salora_16-lr_5e-5"
...
RESULT_DIR="./probing/probing_test/results_with_constraints_ABC/$sDIMENSION/$(basename $LORA_DIR)"
DEVICE="cuda:3"
