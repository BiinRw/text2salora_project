...
def main():
    args = parse_args()
    os.environ['MASTER_PORT'] = str(args.port)
    args.name = 'out/'+str(args.rs)+'_'+str(args.ds)+str(args.more_module)+'qwen_output/qwen_' + args.name +'_rank'+str(args.rank_s)
    try:
        os.mkdir('out/'+str(args.rs)+'_'+str(args.ds)+str(args.more_module)+'qwen_output/')
        print("Make dir "+'out/'+str(args.rs)+'_'+str(args.ds)+str(args.more_module)+'qwen_output/')
    except:
