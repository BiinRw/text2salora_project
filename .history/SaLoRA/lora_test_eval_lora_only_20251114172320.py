...
#lora_path = '../text2salora/protected_lora/output/safety-lora_wo_g_r16_a32-ep1-svd_rank16-salora_16-lr_5e-5'
lora_path = '../text2salora/protected_lora/output/model_output_DPO_UltraFeedback/ipo-r8-Qwen2.5-1.5B-Ins-preference-Qwen2.5-1.5B-Ins-lr1e5-beta0.05/checkpoint-29000'
